(function() {
	...
	function UserController($mdSidenav, $mdBottomSheet, $log, $q, $scope, $element, Fullscreen, $mdToast, $animate, $translate) {
		...
		/** Function for changing the choose medium drop down list */
		$scope.changeMedium = function() {
			changeMediumFn($scope); /** Function defined in experiment.js file */
		}

		/** Function for changing the choose material drop down list */
		$scope.changeMaterial = function() {
			changeMaterialFn($scope); /** Function defined in experiment.js file */
		}

		/** The click event function of switch on light button */
		$scope.switchOn = function() {
			switchOnFn($scope); /** Function defined in experiment.js file */
		}
		
		/** Change event function of rotate glass plate slider */
		$scope.rotateGlassSlider = function() {
			rotateGlassSliderFn($scope); /** Function defined in experiment.js file */
		}
