(function() {
	...
	function UserController($mdSidenav, $mdBottomSheet, $log, $q, $scope, $element, Fullscreen, $mdToast, $animate, $translate) {
		...
		$scope.start = function() {
			startFn($scope); /** Function defined in experiment.js file */
		}

		/** The click event function of switch on light button */
		$scope.switchOn = function() {
			switchOnFn($scope,false); /** Function defined in experiment.js file */
		}

		/** Function for changing the select fiber drop down list */
		$scope.changeFiber = function() {
			changeFiberFn($scope); /** Function defined in experiment.js file */
		}

		/** Function for changing the select laser drop down list */
		$scope.changeLaser = function() {
			changeLaserFn($scope); /** Function defined in experiment.js file */
		}		
		
		/** Change event function of detector distance z slider */
		$scope.detectorDistanceZSlider = function() {
			detectorDistanceZSliderFn($scope); /** Function defined in experiment.js file */
		}

		/** Change event function of detector distance x slider */
		$scope.detectorDistanceXSlider = function() {
			detectorDistanceXSliderFn($scope); /** Function defined in experiment.js file */
		}

		/** Function for changing the radio buttons for toggle the graph/vernier reading */
		$scope.showReadingGraphToggle = function() {
			showReadingGraphToggleFn($scope); /** Function defined in experiment.js file */
		}
